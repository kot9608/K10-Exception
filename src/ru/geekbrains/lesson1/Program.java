...
public class Program {
     ...
     * @param array массив
     * @param searchArray значение для поиска
     * @return -1 -> Длина массива менее трех символов
     *         -2 -> Элемент не найден
     *         -3 -> Массив некорректно проинициализирован
     */
    ...
    static void task5(){
        ...
        try
        {
            int[] res = getSumArray(new int[]{1, -2, 3, 7}, new int[]{4, 2, 1, 9, 0});
            for (int e : res){
                System.out.printf("%d\t", e);
            }
            System.out.println();
    ...
    static int[] getSumArray(int[] array1, int[] array2){
        if (array1 == null || array2 == null)
            throw new NullPointerException("Оба массива должны быть корректно проинициализированы");
